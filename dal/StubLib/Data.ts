...
export const SucessList = [
    ...
    new Sucess("Succès 1", "checkmark-circle-outline", "Description du succès A", 25),
    new Sucess("Succès 2", "checkmark-circle-outline", "Description du succès B", 50),
    new Sucess("Succès 3", "checkmark-circle-outline", "Description du succès C", 75),
    new Sucess("Succès 4", "checkmark-circle-outline", "Description du succès D", 90),
    new Sucess("Succès 5", "checkmark-circle-outline", "Description du succès E", 10),
    new Sucess("Succès 6", "checkmark-circle-outline", "Description du succès F", 60),
    new Sucess("Succès 7", "checkmark-circle-outline", "Description du succès G", 100),
    new Sucess("Succès 8", "checkmark-circle-outline", "Description du succès A", 25),
    new Sucess("Succès 9", "checkmark-circle-outline", "Description du succès B", 50),
    new Sucess("Succès 10", "checkmark-circle-outline", "Description du succès C", 75),
    new Sucess("Succès 11", "checkmark-circle-outline", "Description du succès D", 90),
    new Sucess("Succès 12", "checkmark-circle-outline", "Description du succès E", 10),
    new Sucess("Succès 13", "checkmark-circle-outline", "Description du succès F", 60),
    new Sucess("Succès 14", "checkmark-circle-outline", "Description du succès G", 100),
]
